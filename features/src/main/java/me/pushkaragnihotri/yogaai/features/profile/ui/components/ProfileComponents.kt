package me.pushkaragnihotri.yogaai.features.profile.ui.components
...
fun ProfileScreenPreview() {
    YogaAITheme {
        ProfileScreenContent(HealthConnectClient.SDK_AVAILABLE, hasPermissions = true, steps = 10000, calories = 2500.0) {}
    }
}
...
fun ProfileScreenNoPermissionsPreview() {
    YogaAITheme {
        ProfileScreenContent(HealthConnectClient.SDK_AVAILABLE, hasPermissions = false, steps = 0, calories = 0.0) {}
    }
}
